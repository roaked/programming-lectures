...
Methods
    A method is a function that belongs to a specific object type (e.g., to \texttt{str}).
    
    Examples of string methods:
    \begin{itemize}
        \item \texttt{first\_name.upper()}
        \item \texttt{first\_name.count("a")}
        \item \texttt{first\_name.replace("a", "@")}
    \end{itemize}
