...
\begin{exampleblock}{\textbf{What is happening?}}
    \begin{itemize}
        \item \texttt{name} is like a placeholder that takes on the value of each item in the \texttt{names} list, one at a time
        \item The loop repeats the code block for every item in the list until it reaches the end
    \end{itemize}
\end{exampleblock}
\end{frame}
